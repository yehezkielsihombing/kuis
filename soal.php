...
<div class="row">              
      <div class="col-sm-12 text-center">
		  ...
		  <strong>Aturan Main : </strong> Soal dan jawaban akan tampil secara acak. setiap jawaban benar maka anda mendapat point 10 dan setiap jawaban salah anda tidak mendapatkan point. 
				       ...
				       swal({
					    ...
					    $.ajax({
							...
							success: function(data) {
								...
								if (myarr[0]=='jawaban anda benar, anda dapat 10 point') {
									swal({
										  title: "Benar !",
										  text: myarr[0],
